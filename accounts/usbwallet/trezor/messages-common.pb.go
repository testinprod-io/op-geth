...
const file_messages_common_proto_rawDesc = "" +
	...
	"\x13Failure_PinMismatch\x10\f\x12\x19\n" +
	"\x15Failure_FirmwareError\x10c\"\xe6\x04\n" +
	"\rButtonRequest\x12N\n" +
	"\x04code\x18\x01 \x01(\x0e2:.hw.trezor.messages.common.ButtonRequest.ButtonRequestTypeR\x04code\x12\x12\n" +
	"\x04data\x18\x02 \x01(\tR\x04data\"\xf0\x03\n" +
	...
	"\x1bButtonRequest_MnemonicInput\x10\r\x12 \n" +
	"\x1cButtonRequest_PassphraseType\x10\x0e\x12'\n" +
	"#ButtonRequest_UnknownDerivationPath\x10\x0f\"\v\n" +
	"\tButtonAck\"\xe9\x01\n" +
	"\x10PinMatrixRequest\x12T\n" +
	"\x04type\x18\x01 \x01(\x0e2@.hw.trezor.messages.common.PinMatrixRequest.PinMatrixRequestTypeR\x04type\"\x7f\n" +
	"\x14PinMatrixRequestType\x12 \n" +
	"\x1cPinMatrixRequestType_Current\x10\x01\x12!\n" +
	"\x1dPinMatrixRequestType_NewFirst\x10\x02\x12\"\n" +
	"\x1ePinMatrixRequestType_NewSecond\x10\x03\" \n" +
	"\fPinMatrixAck\x12\x10\n" +
	"\x03pin\x18\x01 \x02(\tR\x03pin\"0\n" +
	"\x11PassphraseRequest\x12\x1b\n" +
	"\ton_device\x18\x01 \x01(\bR\bonDevice\"E\n" +
	...
	"\x05state\x18\x01 \x01(\fR\x05state\"\x14\n" +
	"\x12PassphraseStateAck\"\xc0\x01\n" +
	"\n" +
	"HDNodeType\x12\x14\n" +
	...
	"privateKey\x12\x1d\n" +
	"\n" +
	"public_key\x18\x06 \x01(\fR\tpublicKeyB;Z9github.com/ethereum/go-ethereum/accounts/usbwallet/trezor"
